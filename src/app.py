...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practice and matches for students interested in soccer",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Lap swimming, stroke training, and water fitness",
    ...
    "Science Club": {
        ...
        "max_participants": 18,
        "participants": ["amelia@mergington.edu", "noahj@mergington.edu"]
    },
    "Debate Team": {
...
# Endpoint para desinscribir a un participante de una actividad
